...
SELECT ?depth ?out ?p ?o
  ...
  SERVICE gas:service {
     ...
     gas:program gas:maxIteration 20 . # optional limit on breadth first expansion.
     ...
     gas:program gas:epv <http://sunflower.test/is_abuse_c_of> .
     } .
    FILTER (?p!=<http://sunflower.test/is_admin_c_of> &&
            ?p!=<http://sunflower.test/is_abuse_c_of> ) 
